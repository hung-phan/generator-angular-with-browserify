...
module.exports = [<% if (includeLodash) { %>
    ...
    './app/bower_components/angular-ui-router/release/angular-ui-router.js:angular-ui-router',<% if (includeBindonce) { %>
    './app/bower_components/angular-bindonce/bindonce.js:bindonce',<% } %><% if (includeUIBootstrap) { %>
